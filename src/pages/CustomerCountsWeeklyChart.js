...
const CustomerCountsWeeklyChart = (props) => {
  ...
  if (
    weekDays != "No Customer found in this interval" &&
    weekDays != undefined
  ) {
  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      weekDays === undefined ? (
        ...
        >
          در این هفته هیچ مشتری برای این پارکینگ نداشته اید!{" "}
        </div>
      ) : (
        <div>
          ...
          >
            تعداد مشتریان در هفت روز گذشته
          </div>
        </div>
      )}
    </div>
...
export default CustomerCountsWeeklyChart;
